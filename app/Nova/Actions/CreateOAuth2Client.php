...
class CreateOAuth2Client extends Action
{
    ...
    /**
     * Used to create new OAuth2 clients in Passport
     *
    ...
    {
        return [
            Heading::make('<p>To avoid issues, let the outer page load fully before clicking Run ' .
                'Action.</p>')->asHtml(),
            ...
            Heading::make('<p>Client Types:<ul><li><strong>Standard Client</strong> - Use for most'.
                ...
                ' <li><strong>Public (PKCE-Enabled) Client</strong> - Use for mobile applications or uses not suitable' .
                ' for a standard client. </li>'.
