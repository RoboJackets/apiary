...
@elseif(str_contains(request()->path(), 'update-fields'))
    You do not have permission to change the airfare policy. The airfare policy for this trip can be changed by an officer, if needed.
@else
    You do not have permission to change the airfare policy. The airfare policy for this trip can be changed by an officer after creating the trip, if needed.
@endif
